...
import { LayoutDashboard, BookOpen, Package, Users, LogOut, Settings, CalendarDays, Newspaper } from "lucide-react";
      ...
      <div className="flex flex-1">
        ...
        <nav className="hidden md:flex flex-col gap-1 w-52 shrink-0 border-r border-border bg-surface/30 p-4">
          {[
            ...
            { to: "/admin/intel", label: "Intel", icon: Newspaper },
            { to: "/admin/availability", label: "Calendar", icon: CalendarDays },
