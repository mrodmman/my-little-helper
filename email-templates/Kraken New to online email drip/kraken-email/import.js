...
const templates = [
  {
    ...
    seriesLabel: 'Welcome Series · Email 1 of 5',
    headline: "You're in.",
  ...
  },
  {
    ...
    seriesLabel: 'Welcome Series · Email 2 of 5',
  ...
  },
  {
    ...
    seriesLabel: 'Welcome Series · Email 3 of 5',
  ...
  },
  {
    ...
    seriesLabel: 'Welcome Series · Email 4 of 5',
  ...
  },
  {
    ...
    seriesLabel: 'Welcome Series · Email 5 of 5',
  ...
  },
  {
    ...
    seriesLabel: 'Kraken Vault · Build The System',
  ...
  },
  {
    ...
    seriesLabel: 'Kraken Vault · Limited Time',
...
async function updateAll() {
  console.log('\n🦑 KRAKEN VAULT — RESEND BULK UPDATE');
  console.log('=====================================');
  ...
  for (const t of templates) {
    try {
      ...
      const response = await fetch(`https://api.resend.com/templates/${t.id}`, {
        ...
        body: JSON.stringify({ name: t.name, subject: t.subject, html }),
      });
