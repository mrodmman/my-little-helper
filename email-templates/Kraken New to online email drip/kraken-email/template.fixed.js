// ============================================================
// KEYBOARD KRAKEN — EMAIL HTML BUILDER
// Shared layout for the Jumpstart / online system drip
// ============================================================
...
function buildEmail({ seriesLabel, headline, headlineAccent, body, ctaText, ctaUrl, logoUrl }) {
  ...
  const BADGE_LABEL = seriesLabel || 'Keyboard Kraken';
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td width="48" valign="middle">
              <img src="${LOGO_URL}" width="44" height="44" alt="Keyboard Kraken" style="display:block;border-radius:4px;"/>
            </td>
            <td style="padding-left:12px;" valign="middle">
              <div style="font-family:Arial Black,Arial,sans-serif;font-size:16px;font-weight:900;letter-spacing:1.5px;color:#0a0a0a;text-transform:uppercase;line-height:1.2;">Keyboard Kraken</div>
              <div style="font-family:Arial,sans-serif;font-size:9px;letter-spacing:3px;color:#0A8FE8;text-transform:uppercase;margin-top:3px;">Build The System</div>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td style="padding:32px 32px 24px;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
          <tr>
            ...
            <td style="padding-left:7px;">
              <span style="font-family:Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#0A8FE8;">${BADGE_LABEL}</span>
            </td>
          </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="margin:28px 0 24px;">
          <tr>
            <td style="background:#0A8FE8;border-radius:3px;">
              <a href="${ctaUrl || BRAND_URL}" style="display:inline-block;padding:12px 28px;font-family:Arial Black,Arial,sans-serif;font-size:11px;font-weight:900;letter-spacing:2px;text-transform:uppercase;color:#ffffff;text-decoration:none;">${ctaText || 'Start Building →'}</a>
            </td>
          </tr>
        </table>
        ...
        <div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#777;line-height:1.7;margin-top:8px;">
          ...
          <span style="font-family:Arial Black,Arial,sans-serif;font-size:10px;color:#0A8FE8;letter-spacing:2px;text-transform:uppercase;">Keyboard Kraken</span>
        </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td align="right" style="font-family:Arial,sans-serif;font-size:11px;">
              <a href="https://keyboardkraken.kbkcompanies.com/unsubscribe?email={{{email}}}" style="color:#8a8f98;text-decoration:underline;font-size:12px;font-family:Arial,sans-serif;">Unsubscribe</a>
              <a href="${BRAND_URL}" style="color:#0A8FE8;text-decoration:none;margin-left:14px;">Visit site</a>
            </td>
          </tr>
        </table>
      </td>
