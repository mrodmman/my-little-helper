...
README.md',
  ...
  'The same React + Vite + Cloudflare stack used in this build connects directly to MailerLite, Google Sheets, and automation webhooks in Modules 3 and 4 — no rebuilding required.',
  datetime('now'),
  datetime('now')
);
