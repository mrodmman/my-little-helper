...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-1a-tools-stack-setup', 0, 'Module 1a', 'Tools, Stack & Setup', 'Get online, look professional, pay almost nothing.', 'Wrench', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 0, 'Before You Read Anything Else', 'Let me tell you exactly what this is and what it isn''t.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 1, 'Fast-Track — Already Have Some of This?', 'Check what you''ve already got and jump ahead:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 2, 'Section 1: Your Domain — Your Address on the Internet', '### **What a domain actually is (and why you need one)**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 3, 'Section 2: Professional Email — Stop Using Gmail for Business', '### **Why this matters more than you think**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 4, 'Section 3: The Free Tool Stack — Everything You Need, Almost Nothing You Pay For', 'Here''s every tool you need to run a real online business operation. I''m going to tell you exactly what each one does, why it''s on the list, and how to get it.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 5, 'Section 4: The AI Breakdown — The Real Talk', 'This is the section I wish someone had written for me two years ago. There are so many AI tools right now that it''s genuinely confusing to know which one to use for what. Here''s the honest breakdown.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 7, 'Section 6: The LLC Question — And Why You Don''t Need One Yet', 'Let me just answer this directly because it comes up constantly.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-1a-tools-stack-setup', 8, 'Section 7: Your Module 1a Action Checklist', 'Go through this top to bottom. Every item checked is a real step toward having a professional, functional online business presence.
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-2-the-funnel-system', 1, 'Module 2', 'The Funnel System', 'Build the three-page funnel that turns clicks into leads.', 'GitBranch', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 0, 'Build a Professional "App-Style" Funnel for Free', 'Most tools want to charge you $97–$297/month for funnel software. We''re going to build a full-stack application on Cloudflare for free. You get pro-level speed and reliability without the "guru" tax.

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 1, 'Fast-Track — Already Have Some of This?', '* **Already have a GitHub repo and Cloudflare Pages set up?** Skip to Section 5 — The Build Prompt
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 3, 'Section 1: Understanding the Three-Page Funnel', 'Every funnel in this course uses three core pages. Think of this as the "Kraken Standard."
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 4, 'Section 2: The "App vs. Website" Concept', 'In Module 1a, we set up your domain. Now, instead of just hosting a "page," we are deploying a Codebase.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 5, 'Section 3: Getting Your Code From AI', 'We''re going to use AI to build the "House" (the App). In Module 3, we will install the "Plumbing" (the email form).
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 6, 'Section 4: Moving to GitHub & Cloudflare (The Launch)', '### **Step 1: Create Your GitHub Repository**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 7, 'Section 5: The Funnel Build Prompt (Niche Specifics)', 'When you use the Master Prompt, make sure your `[SITE DEFINITION]` includes these requirements for your specific path:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 8, 'Section 6: Making Your Lead Magnet', 'The "Lead Magnet" is why they give you their email. Here is exactly how to make one in 30 minutes.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 10, 'Section 8: Testing Your Funnel', 'Before you send a single visitor to your site, you must test it.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-2-the-funnel-system', 11, 'Section 9: Module 2 Action Checklist', '* AI Prompted for the full-stack App shell.
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-3-the-email-system', 2, 'Module 3', 'The Email System', 'Welcome, nurture and convert — on autopilot.', 'Mail', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 0, 'Set It Up Once, Let It Sell While You Sleep', 'Social media platforms change their algorithm and your reach drops 80% overnight. TikTok could get banned. Instagram can throttle your links. YouTube can demonetize you without warning.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 1, 'Fast-Track — Already Have Some of This?', '* **Already have MailerLite or EmailOctopus verified?** Skip to Section 2 — The "Plumbing" (AI Injection)
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 2, 'Section 1: Platform Setup — MailerLite or EmailOctopus', 'You signed up for one of these in Module 1a. Now we configure them for the "Kraken" workflow.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 3, 'Section 2: The "Plumbing" (The AI Snippet Injection)', 'In Module 2, your AI built a professional app with a "placeholder" for a form. Now we are going to swap that placeholder for a real, working form from your email provider.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 4, 'Section 3: Your Welcome Sequence — The First Impression', 'The "Welcome Sequence" is the series of emails someone gets immediately after they join your list. We use a 5-email structure:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 5, 'Section 4: The Email Writing Prompt Pack', 'Use this prompt to have the AI write your entire sequence in your voice.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 6, 'Section 5: Deliverability — Staying Out of Spam', '* **Don''t use spam words:** Avoid putting "FREE," "CASH," or "GUARANTEED" in all caps in your subject lines.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-3-the-email-system', 7, 'Section 6: Module 3 Action Checklist', '* Domain Authenticated in MailerLite/EmailOctopus and Cloudflare DNS.
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-4-the-automation-system', 3, 'Module 4', 'The Automation System', 'Wire your stack together so it runs without you.', 'Workflow', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 0, 'Remove the Manual Work and Create Real Leverage', 'Here''s the reality: if you have to manually check three different apps to see if your business is growing, you don''t have a business — you have a chore.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 1, 'Fast-Track — Already Know Automation?', '* **Already have a tracking spreadsheet?** Skip to Section 3 — Telegram Notifications
* **Just want the code to log leads?** Jump to Section 2
* **Want to scale to complex workflows?** Skip to Section 4 — The n8n Path

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 2, 'Section 1: Your Master Tracking System — The Business Hub', 'Before we automate, we need a "Destination." We are going to create your **Business Hub**.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 3, 'Section 2: The Google Sheets Logger (The "AI Bridge")', 'We need to tell your website to send data to your Google Sheet. Use the **Google Sheets + Telegram Automation Prompt** attached to this lesson.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 4, 'Section 3: Telegram Notifications (The Success Ping)', 'We want your phone to notify you the second you get a lead.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 5, 'Section 4: Advanced Automation — The n8n Path', 'If you eventually want to do complex things (like "When I get a sale on Amazon, automatically post a ''Thank You'' to my Telegram Channel"), you will graduate to **n8n**.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 6, 'Section 5: The Automation Mindset', 'Not everything should be automated.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-4-the-automation-system', 7, 'Section 6: Module 4 Action Checklist', '* Business Hub Spreadsheet created with the 4 tabs.
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-5-the-traffic-system', 4, 'Module 5', 'The Traffic System', 'Get real eyeballs — organic first, paid second.', 'TrendingUp', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 0, 'Fast-Track', '* **Already posting content consistently?** Skip to Section 3 — Optimizing What You Post  
* **Ready for paid traffic?** Jump to Section 4 — The Beginner Ad Framework  
* **Just want the posting strategy?** Jump to Section 2

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 1, 'The Only Traffic Truth That Matters', 'Traffic is not the goal. The right traffic is the goal.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 2, 'Section 1: Organic Traffic — The Foundation', 'Organic traffic is any traffic that comes to you without paid advertising. It''s built through content, consistency, and understanding what your specific platform rewards.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 3, 'Section 2: The Posting Strategy — What, When, and Why', '### **What to Post**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 5, 'Section 4: The Beginner Paid Ad Framework', 'Paid ads are a later-stage tool — not a beginner''s first move. Here''s the honest rule:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-5-the-traffic-system', 6, 'Module 5 Action Checklist', '**Platform setup:**
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-6-the-content-system', 5, 'Module 6', 'The Content System', 'Never run out of ideas, hooks or posts again.', 'Video', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 0, 'Fast-Track', '* **Already have a content routine?** Skip to Section 3 — The 30-Day Calendar  
* **Just want the AI prompts?** Jump to Section 4 — The Content Writing Prompt Pack

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 1, 'The System Behind Every Consistent Creator', 'Consistent creators don''t have more ideas than you. They have a system that generates ideas before they need them so they''re never starting from blank.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 2, 'Section 1: The Content Matrix', 'Your content matrix is a simple table. Rows are content buckets. Columns are your topic pillars — the main subjects you talk about.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 3, 'Section 2: The Idea Bank — How to Never Run Out', '**Set up your idea bank right now.** Create a note on your phone called "Content Ideas" or create a tab in your business hub spreadsheet called "Idea Bank" with these columns: `Idea | Hook | Bucket | Status`
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 4, 'Section 3: The 30-Day Content Calendar', 'Here''s a pre-built 30-day calendar framework for Path 1 (Amazon affiliate and online income). Adapt it to your path by swapping the topics while keeping the bucket rotation.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 5, 'Section 4: The Content Writing Prompt Pack', '### **Prompt 1: Video Script Generator**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 6, 'Section 5: Content Kraken Integration', 'Your Content Kraken app (which you''ve built) fits into this system as your content workspace — the place where ideas move from the idea bank to drafted scripts to scheduled posts.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-6-the-content-system', 7, 'Module 6 Action Checklist', '* \[ \] Content matrix built (4 buckets × 3–4 topic pillars)  
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-7-dm-lead-close', 6, 'Module 7', 'DM → Lead → Close', 'Turn DMs into leads without sounding salesy.', 'MessageSquare', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 0, 'Fast-Track', '* **Already doing outreach?** Skip to Section 3 — Objection Handling  
* **Just want the message templates?** Jump to Section 2

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 1, 'Why DMs Are Still the Highest-Converting Channel', 'Email converts better than social. But DMs convert better than email.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 2, 'Section 1: The DM Flow Framework', 'Every DM conversation that moves toward a sale follows this four-step path. Some conversations move through all four steps in one thread. Others develop over days or weeks. The pace follows the person, not your timeline.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 3, 'Section 2: Message Templates', 'These are starting points, not scripts to copy word for word. Your goal is to sound like yourself. Adapt these to your voice and the specific situation.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 4, 'Section 3: Objection Handling', 'Objections are not rejections. An objection means they''re interested enough to engage with reasons not to. Here''s how to handle the most common ones:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 5, 'Section 4: The Non-Salesy DM Strategy — The Meta Principle', 'Here''s the thing nobody writes in their DM template guides: the best DM strategy is to stop thinking about closing and start thinking about connecting.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 6, 'Module 7 Action Checklist', '* \[ \] DM flow framework printed or saved for reference  
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-7-dm-lead-close', 7, 'What''s Next', 'You''ve built the full front end of your system:
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-8-the-offer-vault', 7, 'Module 8', 'The Offer Vault', 'Pick offers that actually pay, stack them properly.', 'Tag', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 0, 'Fast-Track — Already Know What You''re Promoting?', '* # **Have an offer picked and just need the plug-in guide? Jump to Section 4**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 1, 'What This Module Actually Is', '**Every other module in The Kraken Vault built the machine. The funnel, the emails, the automation, the content, the DM system — that''s the infrastructure. It''s real and it works.**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 3, 'Section 2: Where to Find Offers — The Sourcing Guide', '### **Amazon Associates — Your First and Always-On Offer**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 4, 'Section 3: The Offer Evaluation System — 10-Minute Vetting Process', '**Before you spend a single hour promoting any offer, run it through this system. This is the difference between professional affiliate marketing and gambling.**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 6, 'Section 5: Building Your Personal Offer Vault', '**Your offer vault is a living document — not a one-time decision. You add offers, test them, retire the ones that don''t convert for your audience, and replace them with better ones.**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-8-the-offer-vault', 8, 'Module 8 Action Checklist', '**Offer sourcing:**
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-9-the-promotion-system', 8, 'Module 9', 'The Promotion System', 'Run promotions that move your list to buy.', 'Megaphone', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 0, 'Fast-Track', '* **Have an offer and just need the campaign structure?** Skip to Section 2  
* **Want the plug-in guide for a specific offer type?** Jump to Section 3

---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 1, 'What This Module Is For', 'Module 8 gave you the offers. Module 9 gives you the system to promote them.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 2, 'Section 1: The Three Promotion Flows', 'Every offer you run goes through one of three promotion flows depending on how the traffic comes in.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 3, 'Section 2: The Promotion Campaign Checklist', 'Run through this before every promotion campaign, regardless of which flow you''re using.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 4, 'Section 3: Case-Style Promotion Breakdowns', 'Here''s how each offer type from the Offer Vault (Module 8\) gets promoted using the flows above.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-9-the-promotion-system', 5, 'Module 9 Action Checklist', '* \[ \] First promotion campaign planned with flow type selected  
...
INSERT OR REPLACE INTO modules (id, idx, title, subtitle, tagline, icon_name, visible) VALUES ('module-10-build-paths', 9, 'Module 10', 'Build Paths', 'Pick your path. Build the next 90 days.', 'Map', 1);
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 0, 'You Made It Here', 'If you''ve worked through every module in The Kraken Vault, here''s what exists right now:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 3, 'Path B: Resell and Promote Offers Properly', '**What this means:** You build the audience, the funnel, the email list, and the promotion machine — and you fill it with other people''s proven products rather than creating your own. You''re the media company, not the product company.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 4, 'The 90-Day Roadmap — Path A', '**Days 1–30: Validate and Build**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 5, 'The 90-Day Roadmap — Path B', '**Days 1–30: Systematize What You Have**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 6, 'The LLC Conversation — Now It''s Time', 'Remember in Module 1a when we said skip the LLC for now? If you''ve made it here and you''re generating consistent income — it''s time to revisit.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 7, 'Module 10 Action Checklist', '**Path A:**
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 8, 'The End of the Beginning', 'You''ve now gone through the complete Kraken Vault system.
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 9, 'Appendix A: Affiliate Disclosure Template', 'Required by FTC guidelines for all promotional content. Use this or a variation of it anywhere you include affiliate links:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 10, 'Appendix B: Your Full Affiliate Opportunity Reference', 'Every affiliate program mentioned throughout The Kraken Vault:
...
---');
INSERT INTO lessons (module_id, idx, title, content) VALUES ('module-10-build-paths', 11, 'Appendix C: The Quick Start Path — For People Who Want to Move Faster', 'If you''ve read all 10 modules and want the shortest path to your first dollar, here''s the sequence stripped down to essentials:
...
INSERT OR REPLACE INTO assets (id, type, title, description, url, duration, tags) VALUES ('video-welcome', 'video', 'Welcome — how to use The Vault', 'Quick tour of guided mode, Fast Track and asset downloads.', 'https://www.youtube.com/embed/dQw4w9WgXcQ', '3:12', '["onboarding"]');
INSERT OR REPLACE INTO assets (id, type, title, description, body, tags) VALUES ('prompt-cold-dm', 'prompt', 'Cold DM opener (no-pitch)', 'Drop in their handle + niche. Designed to start a real convo.', 'Hey {{name}} — saw your post about {{topic}}. Genuinely curious: what''s the biggest bottleneck you''re hitting with {{outcome}} right now? No pitch, just nerding out on this stuff.', '["dms","outreach"]');
INSERT OR REPLACE INTO assets (id, type, title, description, url, filename, size, format, tags) VALUES ('file-funnel-checklist', 'file', '3-page funnel checklist', 'Every element your landing → offer → thank-you pages need.', '/assets/downloads/funnel-checklist.pdf', 'funnel-checklist.pdf', '180 KB', 'PDF', '["funnel","templates"]');
INSERT OR REPLACE INTO assets (id, type, title, description, url, source, tags) VALUES ('link-tool-stack', 'link', 'Free tool stack (Notion)', 'Live list of every free tool referenced in the course.', 'https://www.notion.so/', 'Notion', '["tools"]');
INSERT OR REPLACE INTO assets (id, type, title, description, url, filename, format, tags) VALUES ('file-prompt-module-2-funnel-shell', 'file', 'Module 2 — Funnel shell build prompt', 'Drop into Claude/ChatGPT to generate the full Cloudflare-ready React + Vite funnel app.', '/prompts/module-2-funnel-shell.md', 'module-2-funnel-shell.md', 'Prompt', '["prompt","module-2","funnel"]');
INSERT OR REPLACE INTO assets (id, type, title, description, url, filename, format, tags) VALUES ('file-prompt-module-3-email-injection', 'file', 'Module 3 — Email form injection prompt', 'Tells the AI exactly which file to edit to swap the placeholder form for your MailerLite / EmailOctopus embed.', '/prompts/module-3-email-form-injection.md', 'module-3-email-form-injection.md', 'Prompt', '["prompt","module-3","email"]');
INSERT OR REPLACE INTO assets (id, type, title, description, url, filename, format, tags) VALUES ('file-prompt-module-4-sheets-telegram', 'file', 'Module 4 — Google Sheets + Telegram automation prompt', 'Generates the Apps Script webhook + Telegram ping and wires it into your funnel.', '/prompts/module-4-sheets-telegram.md', 'module-4-sheets-telegram.md', 'Prompt', '["prompt","module-4","automation"]');
